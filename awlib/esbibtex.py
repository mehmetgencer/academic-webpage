...
translations={
              "in":{"tr":"içinde"},
              "and":{"tr":"ve"},
              "article":{"tr":"Dergi Makalesi"},
              "inproceedings":{"en":"Conference Proceedings","tr":"Konferans Bildiri Kitabı"},
              "inbook":{"en":"Book Chapter","tr":"Kitap Bölümü"},
              "masterthesis":{"en":"Master Thesis","tr":"Yüksek Lisans Tezi"},
              "phdthesis":{"en":"PhD Thesis","tr":"Doktora Tezi"},
              "unpublished":{"tr":"Yayınlanmamış"},
              "techreport":{"en":"Technical Report","tr":"Teknik Rapor"},
              "manual":{"tr":"Kullanım Kılavuz"},
